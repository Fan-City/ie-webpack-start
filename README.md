...
### 介绍
本项目以webpack2为基础，启用tree-shaking新技术,为打包支持到低版本的`webpack2`脚手架。</br>
本项目使用[`avalon2`](http://avalonjs.coding.me/home.html)作为框架。</br>
...
3. 可用ES6编译低版本IE代码
4. 启动新技术tree-shaking
5. 提供测试框架进行单元测试，代码覆盖率报告，可与[Travis-ci](https://travis-ci.org)和[Coveralls](https://coveralls.io)快速对接。
...
1. 首先clone项目
```bash
$ git clone http://git.michaelxu.cn/web-developer/ie-webpack-start.git
$ cd ie-webpack-start
```
